...
# Codesign JAR
# jarsigner -storetype pkcs12 -keystore keystore.pfx build/artifacts/Folume.jar "{YOUR ID HERE}"
...
codesign --force --deep --verbose --sign "Developer ID Application: {YOUR ID HERE}" build/deploy/bundles/Folume.app
...
# Code sign DMG file
codesign --verbose --sign "Developer ID Application: {YOUR ID HERE}" build/deploy/bundles/Folume.dmg
